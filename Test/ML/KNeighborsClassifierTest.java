...
public class KNeighborsClassifierTest {
    ...
    @Test
    public void predict() {
        KNeighborsClassifier kNeighborsClassifier = new KNeighborsClassifier(7);
        kNeighborsClassifier = (KNeighborsClassifier) kNeighborsClassifier.fit(new DenseDoubleMatrix2D(new double[][]{
                {4.8, 3.0, 1.4, 0.3},
                {5.1, 3.8, 1.6, 0.2},
                {4.6, 3.2, 1.4, 0.2},
                {5.3, 3.7, 1.5, 0.2},
